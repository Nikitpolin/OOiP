...
namespace SpaceShip.Tests
{
    ...
    public partial class КорабльДвижетсяПоПрямойFeature : object, Xunit.IClassFixture<КорабльДвижетсяПоПрямойFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public КорабльДвижетсяПоПрямойFeature(КорабльДвижетсяПоПрямойFeature.FixtureData fixtureData, SpaceShip_Tests_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("ru-RU"), "", "корабль движется по прямой", null, ProgrammingLanguage.CSharp, featureTags);
        ...
        [Xunit.TraitAttribute("FeatureTitle", "корабль движется по прямой")]
...
#line hidden
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                КорабльДвижетсяПоПрямойFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                КорабльДвижетсяПоПрямойFeature.FeatureTearDown();
            }
        }
    }
}
